...
public class SplitBeamAction extends AbstractGameAction {
    ...
    public SplitBeamAction(AbstractCreature source, int[] damage, DamageInfo.DamageType damageType, int hits) {
        this.source = source;
        this.amount = hits;
    ...
    private SplitBeamAction(AbstractCreature source, int[] damage, DamageInfo.DamageType damageType, int hits, HashMap<AbstractMonster, Integer> hitMap) {
        this.source = source;
        this.amount = hits;
        this.type = damageType;
        this.damage = damage;
    ...
    public void update() {
        if (amount > 0) {
            ...
            this.addToTop(new SplitBeamAction(source, damage, damageType, amount-1, hitMap));
