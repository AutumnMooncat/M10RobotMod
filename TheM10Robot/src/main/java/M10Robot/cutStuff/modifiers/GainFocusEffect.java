...
public class GainFocusEffect extends AbstractSimpleStackingExtraEffectModifier {
    private static final String ID = M10RobotMod.makeID("GainFocusEffect");

    public GainFocusEffect(AbstractCard card) {
    ...
    public AbstractCardModifier makeCopy() {
        return new GainFocusEffect(attachedCard.makeStatEquivalentCopy());
    }
