...
public class TungstenOrb extends AbstractCustomOrb {

    // Standard ID/Description
    public static final String ORB_ID = M10RobotMod.makeID("TungstenOrb");
    ...
    public TungstenOrb() {
        ...
        linkedPower = new TungstenOrbPower(this);
    ...
    public void onEvoke() { // 1.On Orb Evoke
        this.addToBot(new ApplyPowerAction(p, p, new MetallicizePower(p, evokeAmount)));
    ...
    public AbstractOrb makeCopy() {
        return new TungstenOrb();
    }

    private static class TungstenOrbPower extends AbstractLinkedOrbPower {

        public TungstenOrbPower(AbstractCustomOrb linkedOrb) {
            super(linkedOrb);
        }
        ...
        public int onAttackedToChangeDamage(DamageInfo info, int damageAmount) {
            if (damageAmount > 0) {
                damageAmount = Math.max(0, damageAmount - linkedOrb.passiveAmount);
        ...
        public AbstractPower makeCopy() {
            return new TungstenOrbPower(linkedOrb);
        }
    }
}
