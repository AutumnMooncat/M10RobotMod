...
import M10Robot.powers.AmmoBoxPower;
...
public class AmmoBox extends AbstractDynamicCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p, p, new AmmoBoxPower(p, magicNumber)));
    }
