...
public class LoseEnergyEffect extends AbstractExtraEffectModifier {
    ...
    public LoseEnergyEffect(AbstractCard card, int times) {
    ...
    public AbstractCardModifier makeCopy() {
        return new LoseEnergyEffect(attachedCard, amount);
    }
